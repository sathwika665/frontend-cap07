...
function Landing() {  // Handle the button click to navigate
  const handleConfirm = () => {
    // Optionally, check if the form values are valid
    if (route && year) {
      navigate('/BusTracker'); // Navigate to AnotherComponent
    } else {
...
{/* u r searching in wrong folder */}
{/* bus tracking lo inko bustracking undi howley
aapu+ */}
        <button
